...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    // Determination of drawing color of labeling result
    ...
    // Extraction of maximum area of labeling result
    int max = 0;
    int id = 0;
    ...
    // Drawing a rectangle of maximum area
